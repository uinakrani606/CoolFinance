        ...
        <div className='lg:mt-11 mt-5 '>
          ...
          <div className='border-b border-gray300 lg:pb-14 pb-8 lg:mt-[30px] mt-4 flex md:flex-row flex-col gap-4 text-gray900'>
            <div className='md:max-w-[281px] sm:max-w-full sm:flex-nowrap flex-wrap w-full flex md:block gap-5'>
              <div className='border border-gray300 sm:w-auto w-[45%] rounded-[10px] md:pt-[25px] md:pb-[19px] py-4 md:px-[30px] px-4 md:mb-[14px]'>
              ...
              <div className='border border-gray300 sm:w-auto w-[45%] sm:mx-0 mx-auto rounded-[10px] md:pt-[25px] md:pb-[19px] py-4 md:px-[30px] px-4'>
